...
def upgrade() -> None:
    ...
    op.create_index("idx_emby_user_history_user_action", "emby_user_history", ["emby_user_id", "action"], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index("idx_emby_user_history_user_action", table_name="emby_user_history")
    op.drop_table("emby_user_history")
