  ...
  return (
    ...
    >
      <div className='flex w-full items-center justify-between'>
        <div className='flex items-center text-sm font-medium @2xl/content:hidden'>
          {total !== undefined ? (
      ...
      <div className='flex items-center sm:space-x-6 lg:space-x-8'>
        <div className='flex items-center justify-center text-sm font-medium @max-3xl/content:hidden'>
          {total !== undefined ? (
            <span className='whitespace-nowrap'>共 {total} 条</span>
          ) : (
            <span className='whitespace-nowrap'>Page {currentPage} of {totalPages}</span>
