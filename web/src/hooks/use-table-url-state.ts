...
type UseTableUrlStateReturn = {
  ...
  triggerGlobalFilterSearch?: () => void
  // Column filters
...
export function useTableUrlState(
  ...
  // 手动触发搜索的函数
  const triggerGlobalFilterSearch = useCallback(() => {
    if (!globalFilterEnabled) return
    
    const value = trimGlobal && globalFilter 
      ? globalFilter.trim() 
      : globalFilter
  ...
  }, [globalFilter, globalFilterEnabled, trimGlobal, navigate, pageKey, globalFilterKey])
  ...
  return {
    ...
    triggerGlobalFilterSearch: globalFilterEnabled ? triggerGlobalFilterSearch : undefined,
    columnFilters,
