...
class ConfigModel(Base, BasicAuditMixin):
    ...
    def get_typed_value(self) -> Any:
        ...
        try:
            ...
            if self.config_type == ConfigType.TEXT:
                return self.value
            if self.config_type == ConfigType.LIST:
                return json.loads(self.value) if self.value else []
            if self.config_type == ConfigType.DICT:
                return json.loads(self.value) if self.value else {}
            return self.value
    ...
    def get_display_value(self) -> str:
        ...
        try:
            ...
            if self.config_type in (ConfigType.JSON, ConfigType.LIST, ConfigType.DICT):
    ...
    def is_editable_by_user(self, is_admin: bool = False) -> bool:
        ...
        return not (self.is_system and not is_admin)
