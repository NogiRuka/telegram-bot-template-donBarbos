...
NOTIFY_REJECT_BUTTON = InlineKeyboardButton(text=NOTIFY_REJECT_LABEL, callback_data=NOTIFY_REJECT_CALLBACK_DATA)
NOTIFY_ADD_SENDER_BUTTON = InlineKeyboardButton(text=NOTIFY_ADD_SENDER_LABEL, callback_data=NOTIFY_ADD_SENDER_CALLBACK_DATA)
