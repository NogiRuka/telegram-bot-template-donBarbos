...
FEATURES_PANEL_BUTTON = InlineKeyboardButton(text=USER_FEATURES_PANEL_LABEL, callback_data=USER_FEATURES_PANEL_CALLBACK_DATA)
ADMIN_PERMS_PANEL_BUTTON = InlineKeyboardButton(text=ADMIN_FEATURES_PANEL_LABEL, callback_data=ADMIN_FEATURES_PANEL_CALLBACK_DATA)
