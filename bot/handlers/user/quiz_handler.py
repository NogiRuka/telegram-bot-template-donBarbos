...
async def on_quiz_answer(callback: CallbackQuery, session: AsyncSession):
    """处理问答点击"""
    try:
        ...
        is_correct, reward, msg = await QuizService.handle_answer(session, user_id, answer_index)
